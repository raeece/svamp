 ...
 *
 */
#ifndef TRACKGRAPHFST_H
#define TRACKGRAPHFST_H

#include "trackgraph.h"

class TrackGraphFST : public TrackGraph {
    Q_OBJECT
public:
    TrackGraphFST(QObject* parent) : TrackGraph(parent, "Fst", "Fst") { }
    virtual void calculateData();
    virtual void calculateData(QString& chr);
};

#endif // TRACKGRAPHFST_H
