...
/*=====addition======*/
extern boolean inputnumbers2error, samenumsp2error, odd_mallocerror, eoferror, unknownerr, cursperr, eofspeciesname, illegalchar, dotsinbranch, plusinbranch, dashinbranch, einbranch,
                openloop, commentbracketsserr, treenumerr, speciesmissing;
