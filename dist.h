...
int inputdata(boolean, boolean, boolean, boolean, vector *, intvector *);//function type modified
...
//============my addition================//
extern boolean checkFileFormat, checkZeroDiagonal, checkSymmetric;
extern int unsymcoord1[2], unsymcoord2[2], nonZeroRow;
extern double unsym[2];
//=======================================//
